...
var files_resolver_1 = require("./files/files.resolver");
var files_module_1 = require("./files/files.module");
var AppModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forRoot('mongodb+srv://xyz:RealSuccess@cluster0.uyrrr.mongodb.net/newdb'),
            ...
            providers: [app_service_1.AppService, files_service_1.FilesService, files_resolver_1.FilesResolver],
        })];
